	...
	<!--<link href="libs/css/bootstrap-editable.css" rel="stylesheet">
	<script src="libs/js/bootstrap-editable.min.js"></script>--> 
	<script src="libs/js/popper.min.js"></script>
    <script src="libs/js/bootst	rap.min.js"></script>	
	<script src="libs/js/bootstrap-notify.min.js"></script>	
	<script src="libs/js/jquery.bpopup.min"></script>	
	...
	<script src="//cdn.datatables.net/plug-ins/1.10.16/features/searchHighlight/dataTables.searchHighlight.min.js"></script>	
